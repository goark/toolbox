...
require (
	...
	github.com/goark/koyomi v0.12.0
	github.com/goark/webinfo v0.3.0
...
require (
	...
	github.com/spiegel-im-spiegel/ics-golang v0.1.2 // indirect
	github.com/spiegel-im-spiegel/iso8601duration v0.1.2 // indirect
